...
export const useAppNotifications = () => {
  ...
  const habit = {
    ...
    deleted: (habitName) => showSuccess(`"${habitName}" habit deleted`),
    completed: (habitName) => showSuccess(`"${habitName}" completed!`),
    uncompleted: (habitName) => showInfo(`"${habitName}" marked as incomplete`),
  ...
  const group = {
    ...
    deleted: (groupName) => showSuccess(`"${groupName}" group deleted`),
  ...
  const app = {
    ...
    featureDisabled: (feature) => showWarning(`${feature} is currently disabled`),
