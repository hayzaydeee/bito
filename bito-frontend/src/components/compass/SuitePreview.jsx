 ...
 * Shows all linked compasses in a suite with their phases and habits,
 * with an "Apply All" action and per-compass drill-down.
 */
const SuitePreview = ({
  suite,
  onBack,
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 animate-fade-in">
        ...
        >
          {applyLoading ? (
            ...
            <>
              ...
              Apply All {compasses.length} compasses
            </>
          )}
        </button>
        <button
      ...
      <p className="text-xs font-spartan text-[var(--color-text-tertiary)] text-center">
        You can click each compass to preview, refine, or apply individually.
      </p>
    </div>
  );
};
