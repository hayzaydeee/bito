            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-[var(--color-text-tertiary)] font-outfit">
                  {activeCategory === 'completions' && `${habit.completions} completions`}
                  {activeCategory === 'rate' && `${habit.completionRate.toFixed(1)}% completion rate`}
                  {activeCategory === 'streak' && `${habit.longestStreak} day best streak`}
                </p>
              </div>
        ...
        <div className="mt-6 pt-6 border-t border-[var(--color-border-primary)]/20">
          <div className="flex items-center justify-center gap-2 text-sm text-[var(--color-text-secondary)] font-outfit">
            ...
            <span>
              ...
              {activeCategory === 'streak' && 'Showing longest streaks achieved'}
            </span>
          </div>
        </div>
      )}
